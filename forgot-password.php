...
$message .= "http://dreamchasers.offyoucode.co.uk/notesapp/resetpassword.php?user_id=$user_id&key=$key";
if(mail($email, 'Reset your password', $message, 'From:'.'nikhilkalani486@gmail.com')){
