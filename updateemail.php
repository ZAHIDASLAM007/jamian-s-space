...
$sql = "SELECT * FROM users1 WHERE email='$newemail'";
...
$sql = "UPDATE `users1` SET activation2='$activationKey' WHERE user_id = '$user_id'";
$result = mysqli_query($link, $sql);
if(!$result){
...
$message .= "http://dreamchasers.offyoucode.co.uk/notesapp/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
if(mail($newemail, 'Email Update for you Online Notes App', $message, 'From:'.'nikhilkalani486@gmail.com')){
